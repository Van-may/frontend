		...
		<Container>
			<Row style={{justifyContent: 'space-between', alignItems: 'stretch'}}>
				<Left>
					...
					<div>
						<LinkList style={{display: 'flex', marginTop: 'auto'}}>
							<LinkItem to="https://vanmay.info/">
								<TieP />
							</LinkItem>
							<LinkItem to="https://ramendaily.com/">
								<RameN />
							</LinkItem>
						</LinkList>
					</div>
				...
				<Right xs={12} md={8} lg={6}>
					<LinkSection title="Nội dung">
						<LinkList>
							<LinkItem to="/articles">Nội dung</LinkItem>
							<LinkItem to="/reporteres">Tác giả</LinkItem>
							<LinkItem to="/editorias">Bộ sưu tập</LinkItem>
							<LinkItem to="/tags">Tags</LinkItem>
						</LinkList>
					</LinkSection>
					<LinkSection title="Hỗ trợ">
						<LinkList>
